# DIU26
Prácticas Diseño Interfaces de Usuario (Tema: Restaurante japonés ) 
...
El proceso de desarrollo de diseño siguiendo la metodología UX ha sido muy entretenido e interesante. Nos ha enseñado a no solo centrarnos en el nivel estético y funcional como estábamos acostumbrados hasta antes de empezar con este proyecto, sino a tener en cuenta a los usuarios (uno de los pilares fundamentales de cualquier proyecto). El hecho de analizar la página web de Sibuya y ponernos en los zapatos de nuestros usuarios nos ayudó a entender que diseñar algo con una estética increible es puramente inútil si al usuario se le hace un infierno navegar por la página web sin encontrar lo que busca o sin realizar la acción que desee. Nos pusimos manos a la obra, pasando por momentos bastante elaborados, como el diseño de los wireframe, y por otros más livianos, como el diseño de la página web en sí con sus componentes. Finalmente, se creó la página web de Inazuma Ramen, de la cual estamos muy contentos porque hemos conseguido plasmar en ella lo que estábamos buscando: un buen diseño estético, funcional y fácil de usar para el usuario. Y a las pruebas nos remitimos, vemos que los resultados de la Accesibilidad y Pruebas de Usabilidad A/B testing, destacando la aplicación del Eye Tracking GazeMapping que nos permitió ver donde miraban realmente los usuarios y compararlo con nuestros puntos de interés definidos (POI) y en los cuestionarios SUS obteniendo una puntuación excelente 97,25. Todo esto, nos da un feedback de que hemos conseguido nuestro objetivo. 

Aspectos a mejorar: Debido a los problemas que han surgido en la organización de la temporización de las prácticas, nos hubiera gustado haber dedicado más tiempo a profundizar en React. Estamos bastante agradecidos con la herramienta Figma Make pero nos hubiera gustado poder ajustar y mejorar manualmente el código para lograr una página web más fiel al diseño original.
